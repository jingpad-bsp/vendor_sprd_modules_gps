...
#define GPS_LOCATION_HAS_HORIZONTAL_ACCURACY            0x0010
/** GpsLocation has valid vertical accuracy. */
#define GPS_LOCATION_HAS_VERTICAL_ACCURACY              0x0020
/** GpsLocation has valid speed accuracy. */
#define GPS_LOCATION_HAS_SPEED_ACCURACY                 0x0040
/** GpsLocation has valid bearing accuracy. */
#define GPS_LOCATION_HAS_BEARING_ACCURACY               0x0080
...
/**
 * Name of the Meaurement Corrections interface.
 */
#define GNSS_MEASUREMENT_CORRECTIONS    "gnss_measurement_corrections_interface"

/**
 * Name of the GnssVisibility Control interface.
 */
#define GNSS_VISIBILITY_CONTROL    "gnss_visibility_control_interface"
...
/** including GpsLocation and timestamp. */
typedef struct {
...
//cfgmgt.h
#define CFGMGT_MIN_LEN   32
#define CFGMGT_AVG_LEN   64
#define CFGMGT_MAX_LEN   128

typedef struct
{
    char strChipModule[CFGMGT_MIN_LEN];
    char strGpsImgMode[CFGMGT_MIN_LEN];
    char strGe2Version[CFGMGT_AVG_LEN];
    bool bSpreadOrbitEnable;
    int  nCpMode;
    char strChipId[CFGMGT_MIN_LEN];
    char strOutputProtocol[CFGMGT_MIN_LEN];
    bool bLogEnable;
    char strUartName[CFGMGT_AVG_LEN];
    int  nUartSpeed;
    char strSttyName[CFGMGT_AVG_LEN];
    bool bDebugEnable;
    bool bPostEnable;
    bool bApwdgEnable;
    bool bRealephEnable;
    ...
    bool bTsxEnable;
    bool bRfToolEnable;
    char strSuplPath[CFGMGT_AVG_LEN];
    bool bFloatCn0;
    bool bBasebandMode;
    bool bMeasureReport;
    bool bMinipvt;
...
{
    bool bEnable;
    char strServerAddress[CFGMGT_AVG_LEN];
    int  nServerPort;
    bool bHlpEnable;
    char strHlprAddress[CFGMGT_AVG_LEN];
    int  nHlpPort;
    char strSuplMode[CFGMGT_MIN_LEN];
    char strVersion[CFGMGT_AVG_LEN];
    char strSuplVersion[CFGMGT_AVG_LEN];
    char strAgpsVersion[CFGMGT_AVG_LEN];
    bool bLogEnable;
    bool bResetEnable;
    bool bUdpEnable;
    bool bControlPlane;
    bool bMinPerformance;
    char strMpm[CFGMGT_MIN_LEN];
    bool bExtAddrEnable;
    char strExternalAddress[CFGMGT_AVG_LEN];
    bool bMlcNumberEnable;
    char strMlcNumber[CFGMGT_AVG_LEN];
    bool bCpAutoreset;
    bool bCerVerify;
    char strSuplCer[CFGMGT_MAX_LEN];
    int nCellIdGsmMcc;
    int nCellIdGsmMnc;
    int nCellIdGsmLac;
    int nCellIdGsmCi;
    bool bTlsEnable;
    char strSetId[CFGMGT_MIN_LEN];
    char strAccuracyUnit[CFGMGT_MIN_LEN];
    int nHorizonAccurancy;
    int nVerticalAccurancy;
    int nLocAge;
    int nDelay;
    bool bLabIot;
    bool bEcidEnable;
    ...
    int n3rdMsisdn;
    bool bTriggerStart;
    char strTriggerType[CFGMGT_MIN_LEN];
    int nPeriodicMinInterval;
    int nPeriodicStartTime;
    int nPeriodicStopTime;
    char strPeriodicPosmethod[CFGMGT_MIN_LEN];
    char strAreaPosmethod[CFGMGT_MIN_LEN];
    char strAreaType[CFGMGT_MIN_LEN];
    char strGeographic[CFGMGT_MIN_LEN];
    int nGeoradius;
    float fGeoLat;
    float fGeoLon;
    bool bGeoTrigger;
    char strSign[CFGMGT_MIN_LEN];
    int nAreaMinInterval;
    int nMaxNum;
    int nAreaStartTime;
    int nAreaStopTime;
    bool bNiEnable;
    ...
    int nNotifyTimeout;
    int nVerifyTimeout;
    char strNiTest[CFGMGT_MIN_LEN];
    char strHashAlog[CFGMGT_MIN_LEN];
    bool bRealTime;
    bool bQuasirealTime;
    bool bBatch;
    int nMaxNumPos;
...
#define GNSS_LOG_BUFFER_MAX         (2048)
#define NMEA_MAX_SIZE               1023
#define MAX_FIX_SVS 36 /* used in GSA channel, max 3 mode: eche 12 */
typedef int BOOL;
...
typedef struct {
    ...
    int gnss_used_in_fix_mask[MAX_FIX_SVS];  // save the svid of svs used in fix
...
typedef struct {
    ...
    int      slog_switch;
    int      slogmodem_fd;
    unsigned char  comm_mode; /*  communicate way see GNSSCOMM_MODE_e */
    unsigned char  power_en_mode; /* power way see GNSSPOWER_EN_e */
    unsigned char  tsxmode; /* tsx or tsx_ext see more in GNSSTSXMODE_e */
    unsigned char  chiptype; /* def in GNSSCHIPTYPE_e, for diag test */
    ...
    GnssMeasurementCorrectionCallbacks measurement_corrections_callbacks;
    GnssVisibilityControlCallbacks     visCtrl_callbacks;
    ...
    pthread_t           gnss_data_thread;
    pthread_t           gnss_log_thread;
    pthread_t           gnss_pm_thread;
    pthread_t           ldpc_thread;
    //phread mutex init
    pthread_mutex_t     mutex;
    pthread_mutex_t     gnsslogmutex;
    pthread_mutex_t     gnsslogexmutex;
    pthread_mutex_t     gnssdatamutex;
    pthread_mutex_t     socketmutex;
    pthread_mutex_t     saveMutex;
    pthread_mutex_t     gnsspmmutex;
    pthread_mutex_t     navcMutex;
    pthread_mutex_t     wifimutex;
    pthread_mutex_t     configxmlmutex;
    pthread_mutex_t     measuremutex;
    pthread_mutex_t     navigationmutex;
    pthread_cond_t      cond;
    ...
    int up_ni_status;
    CFGMGT_CONFIG_XML_t gnssCfg;//cfgmgt for config.xml
    CFGMGT_SUPL_XML_t suplCfg;///cfgmgt for supl.xml
    unsigned int proxyapps;
    BOOL         inEmergencyMode;
    BOOL         sensorhubChannel;
    char boardPlatform[128];
    char buildProduct[128];
} GpsState;
